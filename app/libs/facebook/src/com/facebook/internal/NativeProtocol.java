...
public final class NativeProtocol {
    ...
    private static final String FACEBOOK_PROXY_AUTH_ACTIVITY = "appsneva.facebook.katana.ProxyAuth";
    private static final String FACEBOOK_TOKEN_REFRESH_ACTIVITY =
            "appsneva.facebook.katana.platform.TokenRefreshService";
    ...
    static final String INTENT_ACTION_PLATFORM_ACTIVITY = "appsneva.facebook.platform.PLATFORM_ACTIVITY";
    static final String INTENT_ACTION_PLATFORM_SERVICE = "appsneva.facebook.platform.PLATFORM_SERVICE";
    ...
    public static final String EXTRA_PROTOCOL_VERSION =
            "appsneva.facebook.platform.protocol.PROTOCOL_VERSION";
    public static final String EXTRA_PROTOCOL_ACTION =
            "appsneva.facebook.platform.protocol.PROTOCOL_ACTION";
    public static final String EXTRA_PROTOCOL_CALL_ID =
            "appsneva.facebook.platform.protocol.CALL_ID";
    public static final String EXTRA_GET_INSTALL_DATA_PACKAGE =
            "appsneva.facebook.platform.extra.INSTALLDATA_PACKAGE";

    public static final String EXTRA_PROTOCOL_BRIDGE_ARGS =
            "appsneva.facebook.platform.protocol.BRIDGE_ARGS";

    public static final String EXTRA_PROTOCOL_METHOD_ARGS =
            "appsneva.facebook.platform.protocol.METHOD_ARGS";

    public static final String EXTRA_PROTOCOL_METHOD_RESULTS =
            "appsneva.facebook.platform.protocol.RESULT_ARGS";
    ...
    public static final String EXTRA_DIALOG_COMPLETE_KEY =
            "appsneva.facebook.platform.extra.DID_COMPLETE";
    public static final String EXTRA_DIALOG_COMPLETION_GESTURE_KEY =
            "appsneva.facebook.platform.extra.COMPLETION_GESTURE";
    ...
    static final String EXTRA_PROTOCOL_VERSIONS = "appsneva.facebook.platform.extra.PROTOCOL_VERSIONS";

    // Values of EXTRA_PROTOCOL_ACTION supported by PlatformActivity:
    public static final String ACTION_FEED_DIALOG =
            "appsneva.facebook.platform.action.request.FEED_DIALOG";
    public static final String ACTION_MESSAGE_DIALOG =
            "appsneva.facebook.platform.action.request.MESSAGE_DIALOG";
    public static final String ACTION_OGACTIONPUBLISH_DIALOG =
            "appsneva.facebook.platform.action.request.OGACTIONPUBLISH_DIALOG";
    public static final String ACTION_OGMESSAGEPUBLISH_DIALOG =
            "appsneva.facebook.platform.action.request.OGMESSAGEPUBLISH_DIALOG";
    public static final String ACTION_LIKE_DIALOG =
            "appsneva.facebook.platform.action.request.LIKE_DIALOG";
    ...
    public static final String ACTION_APPINVITE_DIALOG =
            "appsneva.facebook.platform.action.request.APPINVITES_DIALOG";

    // Extras supported for ACTION_LOGIN_DIALOG:
    public static final String EXTRA_PERMISSIONS = "appsneva.facebook.platform.extra.PERMISSIONS";
    public static final String EXTRA_APPLICATION_ID = "appsneva.facebook.platform.extra.APPLICATION_ID";
    public static final String EXTRA_APPLICATION_NAME =
            "appsneva.facebook.platform.extra.APPLICATION_NAME";
    public static final String EXTRA_USER_ID = "appsneva.facebook.platform.extra.USER_ID";

    // Extras returned by setResult() for ACTION_LOGIN_DIALOG
    public static final String EXTRA_ACCESS_TOKEN = "appsneva.facebook.platform.extra.ACCESS_TOKEN";
    public static final String EXTRA_EXPIRES_SECONDS_SINCE_EPOCH =
            "appsneva.facebook.platform.extra.EXPIRES_SECONDS_SINCE_EPOCH";
    // EXTRA_PERMISSIONS
    ...
    public static final String STATUS_ERROR_TYPE = "appsneva.facebook.platform.status.ERROR_TYPE";
    public static final String STATUS_ERROR_DESCRIPTION =
            "appsneva.facebook.platform.status.ERROR_DESCRIPTION";
    public static final String STATUS_ERROR_CODE = "appsneva.facebook.platform.status.ERROR_CODE";
    public static final String STATUS_ERROR_SUBCODE = "appsneva.facebook.platform.status.ERROR_SUBCODE";
    public static final String STATUS_ERROR_JSON = "appsneva.facebook.platform.status.ERROR_JSON";
    ...
    private static class KatanaAppInfo extends NativeAppInfo {
        static final String KATANA_PACKAGE = "appsneva.facebook.katana";
    ...
    private static class MessengerAppInfo extends NativeAppInfo {
        static final String MESSENGER_PACKAGE = "appsneva.facebook.orca";
    ...
    private static class WakizashiAppInfo extends NativeAppInfo {
        static final String WAKIZASHI_PACKAGE = "appsneva.facebook.wakizashi";
